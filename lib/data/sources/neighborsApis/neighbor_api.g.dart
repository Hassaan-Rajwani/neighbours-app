...
class _NeighborApiService implements NeighborApiService {
  _NeighborApiService(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<HttpResponse<String>> getJobHistory({
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/user/${id}/history?neighbr=${isNeighbr}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<String>> getUserReviews({
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/user/${id}/review?neighbr=${isNeighbr}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<String>> cancelReview({
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/job/${jobId}/review?neighbr=${isNeighbr}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<String>> postAcceptBid({
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/neighbour/job/${jobId}/bid/${bidId}/accept',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<String>> postRejectBid({
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/neighbour/job/${jobId}/bid/${bidId}/reject',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<String>> confirmPackage({
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/neighbour/job/${jobId}/package/${packageId}/confirm',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<HttpResponse<String>> getChatRooms({required String authToken}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authToken};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<HttpResponse<String>> getNotificationList({
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/notifications?neighbr=${isNeighbr}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<String>> markAsReadNotification({
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/notifications/${notificationId}?neighbr=${isNeighbr}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
