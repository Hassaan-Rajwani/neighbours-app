...
class HelperJobFilterBottomSheet extends StatefulWidget {
  const HelperJobFilterBottomSheet({
    required this.onTap,
  ...
  @override
  State<HelperJobFilterBottomSheet> createState() =>
      _HelperJobFilterBottomSheetState();
}

class _HelperJobFilterBottomSheetState
    extends State<HelperJobFilterBottomSheet> {
  late double _value;
          ...
          AppButton(
            onPress: () async {
              await setDataToStorage(
                StorageKeys.hJobSize,
                '$_selectedTipIndex',
              );
              await setDataToStorage(
                StorageKeys.hJobSorting,
                '$_selectedSortIndex',
              );
              await setDataToStorage(
                StorageKeys.hJjobRating,
                '$ratingCount',
              );
              await setDataToStorage(
                StorageKeys.hJobPickupType,
                '$_selectedPickupTypeIndex',
              );
              await setDataToStorage(StorageKeys.hJobDistance, '$_value');
              widget.onTap!(
                _value,
                _selectedTipIndex,
                _selectedSortIndex,
