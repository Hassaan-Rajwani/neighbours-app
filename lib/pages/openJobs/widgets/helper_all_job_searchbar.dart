...
import 'package:neighbour_app/pages/AllJobs/widgets/helper_job_filter_bottom_sheet.dart';
...
class HelperAllJobSearchBarAndButton extends StatelessWidget {
  const HelperAllJobSearchBarAndButton({
    this.onChangeText,
    this.jobOnTap,
    this.jobOnReset,
    super.key,
          ...
          Row(
            children: [
              ...
              InkWell(
                ...
                onTap: () {
                  helperAllJobsFilterBottomSheet(context);
                },
                child: Container(
  ...
  Future<void> helperAllJobsFilterBottomSheet(BuildContext context) async {
    final sort = await getDataFromStorage(StorageKeys.hJobSorting);
    final size = await getDataFromStorage(StorageKeys.hJobSize);
    final jobMiles = await getDataFromStorage(StorageKeys.hJobDistance);
    final jobRating = await getDataFromStorage(StorageKeys.hJjobRating);
    final jobPickupType = await getDataFromStorage(StorageKeys.hJobPickupType);
    ...
    return showModalBottomSheet<void>(
      ...
      builder: (BuildContext context) {
        return HelperJobFilterBottomSheet(
          onTap: jobOnTap,
          onReset: jobOnReset!,
